...
namespace TimeTracker.Extensions
{
    ...
    {
        public static void AddJwtBearerAuthentification(this IServiceCollection services, IConfiguration configuration)
        {
            services
            ...
            services.AddSwaggerDocument(
                options =>
                {
                    ...
                    options.PostProcess = document =>
                    {
                        ...
                        {
                            Name = "Aleksandar Toprek",
                            Email = string.Empty,
                            Url = "https://github.com/toprek95"
                        };
